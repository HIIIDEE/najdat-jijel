...
/** شعار GitHub — أيقونات العلامات التجارية لم تعد ضمن lucide. */
function GithubMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
      <path d="M12 .5C5.73.5.99 5.24.99 11.5c0 4.86 3.15 8.98 7.52 10.43.55.1.75-.24.75-.53
        0-.26-.01-1.13-.02-2.05-3.06.67-3.71-1.3-3.71-1.3-.5-1.27-1.22-1.61-1.22-1.61-1-.68.08-.67.08-.67
        1.1.08 1.68 1.13 1.68 1.13.98 1.68 2.57 1.19 3.2.91.1-.71.38-1.19.69-1.46-2.44-.28-5.01-1.22-5.01-5.44
        0-1.2.43-2.18 1.13-2.95-.11-.28-.49-1.4.11-2.92 0 0 .92-.29 3.02 1.13a10.4 10.4 0 0 1 5.5 0c2.1-1.42
        3.02-1.13 3.02-1.13.6 1.52.22 2.64.11 2.92.7.77 1.13 1.75 1.13 2.95 0 4.23-2.58 5.16-5.03 5.43.39.34.74 1
        .74 2.02 0 1.46-.01 2.63-.01 2.99 0 .29.2.64.76.53 4.36-1.46 7.51-5.57 7.51-10.43C23.01 5.24 18.27.5 12 .5Z" />
    </svg>
  );
}
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="mt-6 border-t border-white/25 pt-6 text-center">
          <p className="text-base font-bold leading-relaxed">
            {siteConfig.shortName} مجانية بالكامل ومفتوحة المصدر — يستطيع أي شخص الاطلاع على
            الكود المصدري كاملًا والتحقق بنفسه مما تفعله المنصة بالبيانات.
          </p>
          <a
            href={REPO_URL}
            target="_blank"
